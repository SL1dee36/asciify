...
class Asciify:
    def __init__(self):
        ...
        self.font = pg.font.SysFont('Courier', 12, bold=True)  # Default font size
    ...
    def video(self, video_path, color_lvl=32, pixel_size=12, output_path='ascii_col.avi', 
        ...
        Args:
            ...
            output_width (int, optional): The width of the output video. Defaults to None (uses source video width).
            output_height (int, optional): The height of the output video. Defaults to None (uses source video height).
        ...
        # Determine output resolution and frame rate
        output_width = output_width or source_width
        output_height = output_height or source_height
        ...
        while True:
            ...
            recorder.write(cv2.transpose(frame))
    ...
    def image(self, image_path, color_lvl=32, pixel_size=12, output_path=None):
        """
...
acsiify.video(video_path='input.mp4',color_lvl=512)